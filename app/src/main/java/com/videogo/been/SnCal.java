...
//java版计算signature签名
public class SnCal {
    public static String getSnKry(LinkedHashMap paramsMap) throws UnsupportedEncodingException,NoSuchAlgorithmException {
...
//        paramsMap.put("ak", "yourak");
        ...
        String wholeStr = new String("/reverse_geocoding/v3/?" + paramsStr + "GHt34VmSpbcvHHzfs3IuhTrXj1Hk4TZS");
